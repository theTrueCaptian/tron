...
class TronClient extends JFrame implements ActionListener, KeyListener{
  ...
  new AePlayWave("daft_punk.wav").start();
  soundLoop.start();
  menu = new GameMenu();
 ...
 public void goGame(){
  ...
  public void actionPerformed(ActionEvent e){
    if(e.getSource()==soundLoop){new AePlayWave("daft_punk.wav").start();}
  ...
  public class GameMenu extends JPanel implements ActionListener{
    ...
    Image tron1 = toolkit.getImage("tron1.jpg");
    Image tron2 = toolkit.getImage("tron2.jpg");
    Image loading = toolkit.getImage("loading.gif");
    GameMenu(){
      time.start();
